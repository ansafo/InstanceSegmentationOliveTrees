...
def train(model):
    ...
    imgaug.augmenters.Fliplr(0.9), # horizontally flip 99% of all images
    imgaug.augmenters.Flipud(0.9), # vertically flip 99% of all images
    #imgaug.augmenters.AdditiveGaussianNoise(scale=(10, 20)), #Noise gauss
    #imgaug.augmenters.Crop(percent=(0, 0.4)),# crop some of the images by 0-40% of their height/width
    imgaug.augmenters.Affine(
        ...
        shear=(-8, 8),
        order=[0, 1]),
    imgaug.augmenters.ContrastNormalization((0.75, 1.5), per_channel=0.1),#Improve or worsen the contrast of images.
    imgaug.augmenters.Emboss(alpha=(0, 0.1), strength=(0, 2.0)), # # Same as sharpen, but for an embossing effect.
